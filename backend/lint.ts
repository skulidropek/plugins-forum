...
// CHANGE: Скопировали единый линтер-оркестратор из фронтенда для унификации пайплайна в бэкенде.
// WHY: Backend должен использовать тот же eslint-процесс, что и frontend, чтобы соблюсти требование «перенести eslint».
// QUOTE(TЗ): "Перенеси eslint просто из frontend части"
